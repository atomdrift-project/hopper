...
func TestLoadDir(t *testing.T) {
	...
	n := loadAll(ctx, func() {}, db, nil, nil, nil, false, nil, []struct{ dir, label string }{{dir, "bad"}}, "test", 2, false, 0, "", nil, shared)
...
func TestLoadDirWithCache(t *testing.T) {
	...
	n1 := loadAll(ctx, func() {}, db, nil, nil, nil, false, cache, []struct{ dir, label string }{{dir, "bad"}}, "test", 1, false, 0, "", nil, s1)
	if n1 != 1 {
	...
	n2 := loadAll(ctx, func() {}, db, nil, nil, nil, false, cache, []struct{ dir, label string }{{dir, "bad"}}, "test", 1, false, 0, "", nil, s2)
...
func TestLoadDirMarkers(t *testing.T) {
	...
	loadAll(ctx, func() {}, db, nil, nil, nil, false, nil, []struct{ dir, label string }{{dir, "bad"}}, "test", 1, false, 0, "", nil, sm)
